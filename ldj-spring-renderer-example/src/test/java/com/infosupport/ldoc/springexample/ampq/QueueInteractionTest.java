...
class QueueInteractionTest {
  ...
  void filter_empty_post_list() {
    ...
    assertIterableEquals(new ArrayList<QueueInteraction>(), QueueInteraction.getAllPosts(interactions));
  }

  @Test
  void filterReadsReactingToThis() {
    QueueInteraction post = new QueueInteraction("Kees", QueueInteractionKind.POST, "q1", "msg1", null);
    QueueInteraction read = new QueueInteraction("Henk", QueueInteractionKind.READ, "q1", "msg1", null);
    QueueInteraction read2 = new QueueInteraction("Henks alterego", QueueInteractionKind.READ, "q1", "msg1", null);
    QueueInteraction readDecoy1 = new QueueInteraction("Pieter", QueueInteractionKind.READ, "q1", "otherMsg", null);
    QueueInteraction readDecoy2 = new QueueInteraction("Ingrid", QueueInteractionKind.READ, "otherQueue", "msg1", null);
  ...
  void is_read_on_post() {
    QueueInteraction read = new QueueInteraction("henk", QueueInteractionKind.READ, "q1", "msg1", null);
    QueueInteraction post = new QueueInteraction("kees", QueueInteractionKind.POST, "q1", "msg1", null);
    QueueInteraction postDecoy1 = new QueueInteraction("Pieter", QueueInteractionKind.POST, "q1", "otherMsg", null);
    QueueInteraction postDecoy2 = new QueueInteraction("Ingrid", QueueInteractionKind.POST, "otherQueue", "msg1", null);
